# -*- coding: utf-8 -*-
"""
Created on Mon Apr 10 13:30:03 2017
...
###################################################################################################
def main():
    imgTrainingNumbers = cv2.imread("fonttype.png")            # read in training numbers image
...
#    # end if
    imgTrainingNumbers = cv2.resize(imgTrainingNumbers,None, fx = .1, fy = .1)
